...
if (EVENT == 158) then -- Dragon Box
	Dragon = HowmuchItem(UID, 810377000); -- ITEM KONTROL EDILMELI
	if (Dragon < 1) then
...
if EVENT == 167 then 
Check = CheckExchange(UID, 666637050)
   if  Check == true then   
   Roll = RollDice(UID, 4) 
   found = Roll + 666637049
...
if (EVENT == 159) then -- Dragon Box
	Dragon = HowmuchItem(UID, 810342000); -- [Dragon Box] High Class Accessory Box
	if (Dragon < 1) then
		SelectMsg(UID, 2, -1, 11673, NPC, 18, 1000);
	else
...
if (EVENT == 160) then -- Dragon Box
	Dragon = HowmuchItem(UID, 810343000); -- [Dragon Box] 8th Armor Pack
	if (Dragon < 1) then
		SelectMsg(UID, 2, -1, 11673, NPC, 18, 1000);
	else
