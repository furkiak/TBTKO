...
if (EVENT == 170) then -- 1 Level Hunt Worm
	SelectMsg(UID, 2, 101, 170, NPC, 24, 171);
end
...
if (EVENT == 172) then
	SelectMsg(UID, 2, 101, 172, NPC, 24, 171);
end

if (EVENT == 175) then
	SelectMsg(UID, 2, 101, 175, NPC,  25, 176, 13, 168);
end
...
if (EVENT == 180) then
	...
	if (NATION == 1) then
		SelectMsg(UID, 2, 101, 181, NPC, 14, 168);
	else
		SelectMsg(UID, 2, 101, 182, NPC, 14, 168);
	end
end
...
if (EVENT == 185) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 101, 187, NPC, 10, 187, 27, 168);
	end
end
...
if (EVENT == 220) then -- 3 Level Hunt Bandicoot
	SelectMsg(UID, 2, 103, 220, NPC, 24, 221, 14, 222);
end
...
if (EVENT == 223) then
	SelectMsg(UID, 2, 103, 223, NPC, 24, 221, 14, 222);
end
...
if (EVENT == 231) then
	...
	NATION = CheckNation(UID);
	if (NATION == 1) then
		SelectMsg(UID, 2, 103, 232, NPC, 14, 168);
	else
		SelectMsg(UID, 2, 103, 233, NPC, 14, 168);
	end
end
...
if (EVENT == 370) then -- 6 Level Hunt Kekoon
	SelectMsg(UID, 2, 320, 3150, NPC, 24, 371);
end
...
if (EVENT == 372) then
	SelectMsg(UID, 2, 320, 3151, NPC, 24, 371);
end
...
if (EVENT == 303) then
	...
	NATION = CheckNation(UID);
	if (NATION == 1) then
		SelectMsg(UID, 2, 320, 3157, NPC, 14, 168);
	else
		SelectMsg(UID, 2, 320, 3158, NPC, 14, 168);
	end
end
...
if (EVENT == 305) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 320, 3159, NPC, 10, 309, 27, 306);
	end
end
...
if (EVENT == 405) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 321, 3167, NPC, 10, 409, 27, 406);
	end
end
...
if (EVENT == 505) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 322, 3175, NPC, 10, 509, 27, 506);
	end
end
...
if (EVENT == 670) then -- 10 Level Hunt Kekoon Warrior
	SelectMsg(UID, 2, 323, 3176, NPC, 3013, 671);
end
...
if (EVENT == 603) then
	...
	NATION = CheckNation(UID);
	if (NATION == 1) then
		SelectMsg(UID, 2, 323, 3187, NPC, 14, 168);
	else
		SelectMsg(UID, 2, 323, 3188, NPC, 14, 168);
	end
end
...
if (EVENT == 605) then
	...
	if (MonsterCount < 10) then
		...
		SelectMsg(UID, 4, 323, 3189, NPC, 10, 609, 27, 168);
	end
end
...
if (EVENT == 705) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 324, 3807, NPC, 10, 709, 27, 706);
	end
end
...
if (EVENT == 9215) then
	...
	if (MonsterCount < 5) then
		...
		SelectMsg(UID, 4, 886, 8667, NPC, 10, 9217, 27, 168);
	end
end
...
if (EVENT == 805) then
	...
	if (MonsterCount < 10) then
		...
		SelectMsg(UID, 4, 325, 3815, NPC, 10, 809, 27, 806);
	end
end
...
if (EVENT == 9220) then -- 15 Level Hunt Giant Bulcan
	SelectMsg(UID, 2, 887, 8668, NPC, 10, 9221);
end
...
if (EVENT == 9235) then
	MonsterCount = CountMonsterQuestSub(UID, 887, 1);
	if (MonsterCount < 5) then
		SelectMsg(UID, 2, 887, 3172, NPC, 10, 9236);
	else
		SelectMsg(UID, 4, 887, 3175, NPC, 10, 9239, 27, 9236);
	end 
end
...
if (EVENT == 1005) then
	...
	if (MonsterCount < 10) then
		...
		SelectMsg(UID, 4, 327, 3843, NPC, 10, 1009, 27, 1006);
	end
end
...
if (EVENT == 905) then
	...
	if (MonsterCount < 10) then
		...
		SelectMsg(UID, 4, 326, 3823, NPC, 10, 909, 27, 906);
	end
end
...
if (EVENT == 9240) then -- 19 Level Hunt Giant Gavolt
	SelectMsg(UID, 2, 887, 3798, NPC, 10, 9241);
end
...
if (EVENT == 9242) then
	SelectMsg(UID, 2, 887, 3799, NPC, 10, 9241);
end

if (EVENT == 9245) then
	SelectMsg(UID, 2, 887, 3800, NPC, 10, 9246);
end

if (EVENT == 9246) then
	MonsterSub = ExistMonsterQuestSub(UID);
	if (MonsterSub == 0) then
		SelectMsg(UID, 4, 887, 3801, NPC, 22, 9247, 23, 168);
	else
		SelectMsg(UID, 2, 887, 173, NPC, 10, 168);
	end
end
...
if (EVENT == 9250) then
	...
	NATION = CheckNation(UID);
	if (NATION == 1) then
		SelectMsg(UID, 2, 887, 3805, NPC, 14, 168);
	else
		SelectMsg(UID, 2, 887, 3806, NPC, 14, 168);
	end
end

if (EVENT == 9255) then
	MonsterCount = CountMonsterQuestSub(UID, 888, 1);
	if (MonsterCount < 5) then
...
if (EVENT == 9275) then
	MonsterCount = CountMonsterQuestSub(UID, 890, 1);
...
if (EVENT == 9295) then
	MonsterCount = CountMonsterQuestSub(UID, 891, 1);
	if (MonsterCount < 10) then
		SelectMsg(UID, 2, 891, 3804, NPC, 10, 9296);
	else
		SelectMsg(UID, 4, 891, 3815, NPC, 10, 9297, 27, 9296);
	end
end
...
if (EVENT == 8636) then
	MonsterCount = CountMonsterQuestSub(UID, 822, 1);
	if (MonsterCount < 5) then
