...
#define ZONE_MONSTER_SQUAD1     81
#define ZONE_MONSTER_SQUAD2     82
#define ZONE_MONSTER_SQUAD3     83
...
#define ZONE_CLAN_WAR			77
#define	ZONE_NEW_RONARK_EVENT	78
