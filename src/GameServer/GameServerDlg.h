...
public:	
	...
	void ChaosTerminationTimeActive();
	void JuraidTerminationTimeActive();
	void BorderDefenseWarTerminationTimeActive();
	...
	uint32  m_nPlayerRankingLoyaltyReward,m_Grade1,m_Grade2,m_Grade3,m_Grade4,m_Drop1,m_Drop2,m_Drop3,m_Drop4,m_Drop5,m_gDrop1,m_gDrop2,
		m_gDrop3,m_gDrop4,m_gDrop5,m_sling,f_Drop1,f_Drop2,f_Drop3,f_gDrop1,f_gDrop2,f_gDrop3;
